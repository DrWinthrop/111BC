...
\begin{enumerate}
    \item \emph{\textbf{Note: In order to view the private Youtube videos hosted by the university, you must be signed into your berkeley.edu Google account.}} View the \href{http://youtu.be/PVgqyf3kNRs}{\textbf{Compton Scattering video}} and \href{http://youtu.be/lQKLakISoBA}{\textbf{``Light Sources and Detectors'' video}}.
