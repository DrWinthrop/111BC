...
\begin{minipage}{.49\linewidth}
    \centering
    \href{REPLACE}{\includegraphics[width=\linewidth,keepaspectratio]{images/REPLACE.JPG}} \\
    \caption{Radiation Shield Front View}
\end{minipage}\hfill
\begin{minipage}{.49\linewidth}
    \centering
    \href{http://REPLACE}{\includegraphics[width=\linewidth,keepaspectratio]{images/REPLACE.JPG}} \\
...
\begin{minipage}{.49\linewidth}
    \centering
    \href{http://experimentationlab.berkeley.edu/sites/default/files/upimages/Detector-Exposed.JPG}{\includegraphics[width=\linewidth,keepaspectratio]{images/REPLACE.JPG}} \\
