...
\begin{minipage}{.40\linewidth}
    \centering
    \href{http://experimentationlab.berkeley.edu/sites/default/files/images/COM_3526-Lg.JPG}{\includegraphics[height=200pt,keepaspectratio]{images/COM_3526-Lg.JPG}} \\
...
\begin{minipage}{.59\linewidth}
    \centering
    \href{http://experimentationlab.berkeley.edu/sites/default/files/images/COM_Inside_3525-Lg.JPG}{\includegraphics[height=200pt,keepaspectratio]{images/COM_Inside_3525-Lg.JPG}} \\
...
\begin{minipage}{.49\linewidth}
    ...
    \caption{Incorrect usage of the shield. The detector is not completely blocked from the source.}
...
\begin{minipage}{.49\linewidth}
    ...
    \caption{Correct usage of the shield. Now the detector is completely blocked from the radiation source.}
