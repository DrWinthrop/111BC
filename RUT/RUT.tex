...
\begin{enumerate}
    ...
    \item Now complete the  \href{http://experimentationlab.berkeley.edu/RadiationSafety}{\textbf{Radiation Safety Training}}. \textbf{After completion of training turn in all forms to Don Orlando.}
...
\[
\frac{d\sigma}{d\Omega} = \left( \frac{1}{4 \pi \epsilon_0} \frac{Z_1 Z_2 e^2}{4E} \right)^2 \sin^{-4} \frac{\theta}{2}
\]
