...
The source of alpha particles is the isotope 241 of Americium at 130uCi. Its half-life is 458 years. The energies of emitted alpha particles are 5.49 MeV (86\%), 5.44 MeV (13\%), and 5.39 MeV (1.3\%). This also has a 59.6 Kev X-Ray which is used in the Compton experiment (neglecting other very infreguent α energies, all in the range of 5.55 to 4.8 Mev). The Americium is deposited as a thin layer on an aluminum foil located in the gun as shown below in Figure \ref{fig:DiagramOfVacuumChamber}. This deposit randomly flakes off so always wear your gloves.
