...
\begin{enumerate}
    ...
    \item Get your \href{http://experimentationlab.berkeley.edu/sites/default/files/writeups/\@labacronym_Signatures.pdf}{\textbf{Mid Lab}} signed off. This should be the end of day 2.
\end{enumerate}
