...
\href{http://experimentationlab.berkeley.edu/sites/default/files/images/LLS-Source_3439.jpg}{\includegraphics[width=0.33\linewidth,keepaspectratio]{images/LLS-Source_3439.jpg}}
...
\begin{enumerate}
    ...
    \item SRS SR570 Preamplifier \href{http://experimentationlab.berkeley.edu/defaultsettings}{\textbf{default settings}}
...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \item \textbf{The data look very ``spiky''. WHY IS THIS A PROBLEM (this is a question for you to answer)?} The SAMPLE RATE is probably too low. Increase it. Your data should look rather rounded and contain as many ``periods'' as possible. See \emph{\textbf{Figure \ref{fig:DataNotSpikyAndHavePeriods}.}}
