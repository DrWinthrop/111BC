...
\begin{enumerate}
    \item View the\textbf{ }\href{http://experimentationlab.berkeley.edu/sites/default/files/QIE/qie\_introduction\_final2.mp4}{\textbf{introduction video}} or this experiment. Read the references \cite{Dehlinger,Bell,Clauser} below. \cite{Dehlinger} is particularly useful.
...
\begin{enumerate}
    ...
    \item Run the LabVIEW program (latest version: C:\textbackslash QIE\_Counter\textbackslash QIE Counter.exe, see \hyperref[subsec:UsingLabVIEWProgram]{using LabVIEW}).
\end{enumerate}
...
\noindent
\href{http://experimentationlab.berkeley.edu/sites/default/files/images/Qe_overview.jpeg}{\includegraphics[width=0.25\linewidth,keepaspectratio]{images/Qe_overview.jpeg}}
\href{http://experimentationlab.berkeley.edu/sites/default/files/images/Qe_405interference.jpeg}{\includegraphics[width=0.25\linewidth,keepaspectratio]{images/Qe_405interference.jpeg}}
\href{http://experimentationlab.berkeley.edu/sites/default/files/images/Qe_beamview.jpeg}{\includegraphics[width=0.25\linewidth,keepaspectratio]{images/Qe_beamview.jpeg}}
\href{http://experimentationlab.berkeley.edu/sites/default/files/images/Qe_slit.jpeg}{\includegraphics[width=0.25\linewidth,keepaspectratio]{images/Qe_slit.jpeg}}
...
\label{sec:References}
    ...
    \bibitem{Bell}
    J.S. Bell, \href{http://www.drchinese.com/David/Bell\_Compact.pdf}{\textbf{``On the Einstein Podolsky Roden paradox''}}.
