...
%\newcommand{\}{http://dev-physicsadv.pantheon.berkeley.edu/sites/default/files/AFMImages/AFMprobe.JPG}
%\newcommand{\}{http://dev-physicsadv.pantheon.berkeley.edu/sites/default/files/AFMImages/26.png}
...
\begin{itemize}
    ...
    \item \href{http://experimentationlab.berkeley.edu/afm-book}{\textbf{\textbf{Atomic Force Microscopy}}} by Peter Eaton and Paul West (It's a book)
    \begin{itemize}
...
\begin{figure}[h]
    \centering
    \href{http://dev-physicsadv.pantheon.berkeley.edu/sites/default/files/AFMImages/2_0.png}{\includegraphics[width=0.1\linewidth]{images/2_0.png}}
    \caption{}
    \label{fig:2_0}
\end{figure}
...
\begin{figure}[h]
    \centering
    \href{http://dev-physicsadv.pantheon.berkeley.edu/sites/default/files/AFMImages/AFMgen.jpg}{\includegraphics[width=0.1\linewidth]{images/AFMgen.jpg}}
    \caption{}
    \label{fig:AFMgen}
\end{figure}
...
\begin{figure}[h]
    \centering
    \href{http://dev-physicsadv.pantheon.berkeley.edu/sites/default/files/AFMImages/AFMlasermirror.png}{\includegraphics[width=0.1\linewidth]{images/AFMlasermirror.png}}
    \caption{}
...
\noindent
\href{http://dev-physicsadv.pantheon.berkeley.edu/sites/default/files/AFMImages/AFMdiagram.png}{\includegraphics[width=0.33\linewidth,keepaspectratio]{images/AFMdiagram.png}}
\href{http://dev-physicsadv.pantheon.berkeley.edu/sites/default/files/AFMImages/AFMstage2.PNG}{\includegraphics[width=0.33\linewidth,keepaspectratio]{images/AFMstage2.PNG}}

\textbf{Figure 5                                                                                Figure 6}
...
\begin{itemize}
    \item The EBOX is located on the shelf behind the AFM.  The EBOX houses the DAQ and connects/interfaces the AFM hardware with the software on the computer.

\end{itemize}

\noindent
\href{http://dev-physicsadv.pantheon.berkeley.edu/sites/default/files/EBOX.jpg}{\includegraphics[width=0.33\linewidth,keepaspectratio]{images/EBOX.jpg}}
\href{http://dev-physicsadv.pantheon.berkeley.edu/sites/default/files/AFMImages/AFMconnections.PNG}{\includegraphics[width=0.33\linewidth,keepaspectratio]{images/AFMconnections.PNG}}
...
\begin{figure}[h]
    \centering
    \href{http://dev-physicsadv.pantheon.berkeley.edu/sites/default/files/AFMImages/infeedback.JPG}{\includegraphics[width=0.1\linewidth]{images/infeedback.JPG}}
    \caption{}
...
\begin{figure}[h]
    \centering
    \href{http://dev-physicsadv.pantheon.berkeley.edu/sites/default/files/AFMImages/prescantab.JPG}{\includegraphics[width=0.1\linewidth]{images/prescantab.JPG}}
    \caption{}
...
\begin{figure}[h]
    \centering
    \href{http://dev-physicsadv.pantheon.berkeley.edu/sites/default/files/AFMImages/AFMwoodpecker.png}{\includegraphics[width=0.1\linewidth]{images/AFMwoodpecker.png}}
    \caption{}
...
\begin{figure}[h]
    \centering
    \href{http://dev-physicsadv.pantheon.berkeley.edu/sites/default/files/AFMImages/toposcan.JPG}{\includegraphics[width=0.1\linewidth]{images/toposcan.JPG}}
    \caption{}
    \label{fig:toposcan}
\end{figure}
...
\begin{figure}[h]
    \centering
    \href{http://dev-physicsadv.pantheon.berkeley.edu/sites/default/files/AFMImages/systemtab.JPG}{\includegraphics[width=0.1\linewidth]{images/systemtab.JPG}}
    \caption{}
    \label{fig:systemtab}
\end{figure}
...
\noindent
\href{http://dev-physicsadv.pantheon.berkeley.edu/sites/default/files/AFMImages/LED1.jpg}{\includegraphics[width=0.33\linewidth,keepaspectratio]{images/LED1.jpg}}
\href{http://dev-physicsadv.pantheon.berkeley.edu/sites/default/files/AFMImages/LED2.jpg}{\includegraphics[width=0.33\linewidth,keepaspectratio]{images/LED2.jpg}}
...
\begin{figure}[h]
    \centering
    \href{http://dev-physicsadv.pantheon.berkeley.edu/sites/default/files/AFMImages/12.JPG}{\includegraphics[width=0.1\linewidth]{images/12.JPG}}
    \caption{}
    \label{fig:12}
\end{figure}
...
\begin{figure}[h]
    \centering
    \href{http://dev-physicsadv.pantheon.berkeley.edu/sites/default/files/AFMImages/AFMstagespace_0.jpg}{\includegraphics[width=0.1\linewidth]{images/AFMstagespace_0.jpg}}
    \caption{}
...
\begin{figure}[h]
    \centering
    \href{http://dev-physicsadv.pantheon.berkeley.edu/sites/default/files/AFMImages/14.JPG}{\includegraphics[width=0.1\linewidth]{images/14.JPG}}
    \caption{}
    \label{fig:14}
\end{figure}
...
\begin{figure}[h]
    \centering
    \href{http://dev-physicsadv.pantheon.berkeley.edu/sites/default/files/AFMImages/15.JPG}{\includegraphics[width=0.1\linewidth]{images/15.JPG}}
    \caption{}
    \label{fig:15}
\end{figure}
...
\begin{figure}[h]
    \centering
    \href{http://dev-physicsadv.pantheon.berkeley.edu/sites/default/files/AFMImages/ProbeHolderExchange.png}{\includegraphics[width=0.1\linewidth]{images/ProbeHolderExchange.png}}
    \caption{}
...
\begin{figure}[h]
    \centering
    \href{http://dev-physicsadv.pantheon.berkeley.edu/sites/default/files/AFMImages/17.JPG}{\includegraphics[width=0.1\linewidth]{images/17.JPG}}
    \caption{}
    \label{fig:17}
\end{figure}
...
\begin{figure}[h]
    \centering
    \href{http://dev-physicsadv.pantheon.berkeley.edu/sites/default/files/AFMImages/18.JPG}{\includegraphics[width=0.1\linewidth]{images/18.JPG}}
    \caption{}
    \label{fig:18}
\end{figure}
...
\begin{figure}[h]
    \centering
    \href{http://dev-physicsadv.pantheon.berkeley.edu/sites/default/files/AFMImages/19.JPG}{\includegraphics[width=0.1\linewidth]{images/19.JPG}}
    \caption{}
    \label{fig:19}
\end{figure}
...
\begin{figure}[h]
    \centering
    \href{http://dev-physicsadv.pantheon.berkeley.edu/sites/default/files/AFMImages/20.JPG}{\includegraphics[width=0.1\linewidth]{images/20.JPG}}
    \caption{}
    \label{fig:20}
\end{figure}
...
\begin{figure}[h]
    \centering
    \href{http://dev-physicsadv.pantheon.berkeley.edu/sites/default/files/AFMImages/AFMprobe.JPG}{\includegraphics[width=0.1\linewidth]{images/AFMprobe.JPG}}
    \caption{}
    \label{fig:AFMprobe}
\end{figure}
...
\begin{figure}[h]
    \centering
    \href{http://dev-physicsadv.pantheon.berkeley.edu/sites/default/files/AFMImages/21.JPG}{\includegraphics[width=0.1\linewidth]{images/21.JPG}}
    \caption{}
    \label{fig:21}
\end{figure}
...
\begin{figure}[h]
    \centering
    \href{http://dev-physicsadv.pantheon.berkeley.edu/sites/default/files/AFMImages/22.JPG}{\includegraphics[width=0.1\linewidth]{images/22.JPG}}
    \caption{}
    \label{fig:22}
\end{figure}
...
\begin{figure}[h]
    \centering
    \href{http://dev-physicsadv.pantheon.berkeley.edu/sites/default/files/AFMImages/sampleholder.PNG}{\includegraphics[width=0.1\linewidth]{images/sampleholder.PNG}}
    \caption{}
...
\begin{figure}[h]
    \centering
    \href{http://dev-physicsadv.pantheon.berkeley.edu/sites/default/files/AFMImages/laser_align.png}{\includegraphics[width=0.1\linewidth]{images/laser_align.png}}
    \caption{}
...
\begin{figure}[h]
    \centering
    \href{http://dev-physicsadv.pantheon.berkeley.edu/sites/default/files/AFMImages/detectoralign.JPG}{\includegraphics[width=0.1\linewidth]{images/detectoralign.JPG}}
    \caption{}
...
\begin{figure}[h]
    \centering
    \href{http://dev-physicsadv.pantheon.berkeley.edu/sites/default/files/AFMImages/ZControl.jpg}{\includegraphics[width=0.1\linewidth]{images/ZControl.jpg}}
    \caption{}
    \label{fig:ZControl}
\end{figure}
...
\begin{figure}[h]
    \centering
    \href{http://dev-physicsadv.pantheon.berkeley.edu/sites/default/files/AFMImages/26.png}{\includegraphics[width=0.1\linewidth]{images/26.png}}
    \caption{}
    \label{fig:26}
\end{figure}
...
\begin{figure}[h]
    \centering
    \href{http://dev-physicsadv.pantheon.berkeley.edu/sites/default/files/AFMImages/probe_unfocused1_0.png}{\includegraphics[width=0.1\linewidth]{images/probe_unfocused1_0.png}}
    \caption{}
...
\begin{figure}[h]
    \centering
    \href{http://dev-physicsadv.pantheon.berkeley.edu/sites/default/files/AFMImages/FreqPhase.JPG}{\includegraphics[width=0.1\linewidth]{images/FreqPhase.JPG}}
    \caption{}
    \label{fig:FreqPhase}
\end{figure}
...
\begin{figure}[h]
    \centering
    \href{http://dev-physicsadv.pantheon.berkeley.edu/sites/default/files/AFMImages/probe_unfocused2_0.png}{\includegraphics[width=0.1\linewidth]{images/probe_unfocused2_0.png}}
    \caption{}
...
\begin{figure}[h]
    \centering
    \href{http://dev-physicsadv.pantheon.berkeley.edu/sites/default/files/AFMImages/bothfocused.jpg}{\includegraphics[width=0.1\linewidth]{images/bothfocused.jpg}}
    \caption{}
...
\begin{figure}[h]
    \centering
    \href{http://dev-physicsadv.pantheon.berkeley.edu/sites/default/files/AFMImages/toposcansetup.jpg}{\includegraphics[width=0.1\linewidth]{images/toposcansetup.jpg}}
    \caption{}
...
\begin{figure}[h]
    \centering
    \href{http://dev-physicsadv.pantheon.berkeley.edu/sites/default/files/AFMImages/39.png}{\includegraphics[width=0.2\linewidth]{images/39.png}}
    \caption{}
    \label{fig:39}
\end{figure}
...
\begin{figure}[h]
    \centering
    \href{http://dev-physicsadv.pantheon.berkeley.edu/sites/default/files/AFMImages/40.png}{\includegraphics[width=0.1\linewidth]{images/40.png}}
    \caption{}
    \label{fig:40}
\end{figure}
...
\begin{figure}[h]
    \centering
    \href{http://dev-physicsadv.pantheon.berkeley.edu/sites/default/files/AFMImages/43.png}{\includegraphics[width=0.1\linewidth]{images/43.png}}
    \caption{}
    \label{fig:43}
\end{figure}
...
\begin{figure}[h]
    \centering
    \href{http://dev-physicsadv.pantheon.berkeley.edu/sites/default/files/AFMImages/45.png}{\includegraphics[width=0.1\linewidth]{images/45.png}}
    \caption{}
    \label{fig:45}
\end{figure}
...
\begin{figure}[h]
    \centering
    \href{http://dev-physicsadv.pantheon.berkeley.edu/sites/default/files/AFMImages/47.png}{\includegraphics[width=0.1\linewidth]{images/47.png}}
    \caption{}
    \label{fig:47}
\end{figure}
...
\begin{figure}[h]
    \centering
    \href{http://dev-physicsadv.pantheon.berkeley.edu/sites/default/files/AFMImages/49.png}{\includegraphics[width=0.1\linewidth]{images/49.png}}
    \caption{}
    \label{fig:49}
\end{figure}
...
\begin{figure}[h]
    \centering
    \href{http://dev-physicsadv.pantheon.berkeley.edu/sites/default/files/AFMImages/51.png}{\includegraphics[width=0.1\linewidth]{images/51.png}}
    \caption{}
    \label{fig:51}
\end{figure}
...
\begin{figure}[h]
    \centering
    \href{http://dev-physicsadv.pantheon.berkeley.edu/sites/default/files/AFMImages/53.png}{\includegraphics[width=0.1\linewidth]{images/53.png}}
    \caption{}
    \label{fig:53}
\end{figure}
...
\begin{figure}[h]
    \centering
    \href{http://dev-physicsadv.pantheon.berkeley.edu/sites/default/files/AFMImages/54.png}{\includegraphics[width=0.1\linewidth]{images/54.png}}
    \caption{}
    \label{fig:54}
\end{figure}
