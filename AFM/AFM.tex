...
\begin{itemize}
    ...
    \begin{center}
        \href{http://experimentationlab.berkeley.edu/sites/default/files/AFMImages/scanningmethod.jpg}{\includegraphics[width=0.65\linewidth]{images/scanningmethod.jpg}}
    \end{center}
...
\begin{center}
    \href{http://experimentationlab.berkeley.edu/sites/default/files/AFMImages/detectoralign.JPG}{\includegraphics[width=0.8\linewidth]{images/detectoralign.JPG}}
\end{center}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Click the floppy disk button to save your 3D image at any time.
        \begin{figure}[H]
            \centering
...
\begin{enumerate}
    ...
    \item ``Each pit is approximately 125 \href{https://en.wikipedia.org/wiki/Nanometre}{\textbf{nm}} deep by 600 nm wide, and varies from 850 nm to 3.5 \href{https://en.wikipedia.org/wiki/Micrometre}{\textbf{$\mu$m}} in length.The distance between the tracks, the pitch, is 1.6 µm.''
