...
\begin{enumerate}
    ...
    \item Along with the sample containers, there should also be 2 optical disks clearly labeled as "blank CD" and "CD with data". The DVD samples are already mounted, but you'll have to remove the blueish plastic covering before scanning. Additionally, there should be a set of magnetic sample plates labeled for use with the CDs, and a small plastic bag with silicon wafers labeled "SiO$_2$ Chip Mounts".
