...
\centering
  \href{http://experimentationlab.berkeley.edu/sites/default/files/AFMImages/AFMprobe.JPG}{\includegraphics[height=230,keepaspectratio]{images/AFMprobe.JPG}}
  \caption{AFM probe bottom view}
  \label{fig:AFMProbe}
\endminipage\hfill
\minipage{0.43\textwidth}
\centering
  \href{http://experimentationlab.berkeley.edu/sites/default/files/AFMImages/26.png}{\includegraphics[height=230,keepaspectratio]{images/26.png}}
...
\subsubsec{\textbf{What is the Piezoelectric Effect?}}
...
\begin{itemize}
    ...
    \centering
      \href{http://experimentationlab.berkeley.edu/sites/default/files/AFMImages/AFMdiagram.png}{\includegraphics[height=150,keepaspectratio]{images/AFMdiagram.png}}
      \caption{Piezo integration}
      \label{fig:PiezoIntegration}
    \endminipage\hfill
    \minipage{0.52\textwidth}
    \centering
      \href{http://experimentationlab.berkeley.edu/sites/default/files/AFMImages/AFMstage2.PNG}{\includegraphics[height=150,keepaspectratio]{images/AFMstage2.PNG}}
      \caption{Laser Setup}
...
\centering
  \href{http://experimentationlab.berkeley.edu/sites/default/files/EBOX.jpg}{\includegraphics[height=150,keepaspectratio]{images/EBOX.jpg}}
  \caption{AFM EBOX}
  \label{fig:EBox}
\endminipage\hfill
\minipage{0.69\textwidth}
\centering
  \href{http://experimentationlab.berkeley.edu/sites/default/files/AFMImages/AFMconnections.PNG}{\includegraphics[height=150,keepaspectratio]{images/AFMconnections.PNG}}
...
\begin{enumerate}
    ...
    \centering
         \href{http://experimentationlab.berkeley.edu/sites/default/files/AFMImages/AFMprobe.JPG}{\includegraphics[height=180]{images/AFMprobe.JPG}}
        \caption{AFM probe bottom view}
        \end{minipage}\hfill
    \begin{minipage}{0.59\linewidth}
        \centering
        \href{http://experimentationlab.berkeley.edu/sites/default/files/AFMImages/21.JPG}{\includegraphics[height=180]{images/21.JPG}}
...
\begin{figure}[H]
    ...
    \centering
    \href{http://experimentationlab.berkeley.edu/sites/default/files/AFMImages/26.png}{\includegraphics[height=230]{images/26.png}}
    \caption{Top and side views of the cantilever}
    \end{minipage}\hfill
    \begin{minipage}{0.6\linewidth}
    \centering
    \href{http://experimentationlab.berkeley.edu/sites/default/files/AFMImages/probe_unfocused1_0.png}{\includegraphics[height=230]{images/probe_unfocused1_0.png}}
