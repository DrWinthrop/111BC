...
\begin{enumerate}
    ...
    \centering
         \href{http://experimentationlab.berkeley.edu/sites/default/files/AFMImages/AFMprobe.JPG}{\includegraphics[height=180\px]{images/AFMprobe.JPG}}
        \caption{AFM probe bottom view}
        \end{minipage}\hfill
    \begin{minipage}{0.59\linewidth}
        \centering
        \href{http://experimentationlab.berkeley.edu/sites/default/files/AFMImages/21.JPG}{\includegraphics[height=180\px]{images/21.JPG}}
...
\begin{figure}[H]
    ...
    \centering
    \href{http://experimentationlab.berkeley.edu/sites/default/files/AFMImages/26.png}{\includegraphics[height=230\px]{images/26.png}}
    \caption{Top and side views of the cantilever}
    \end{minipage}\hfill
    \begin{minipage}{0.6\linewidth}
    \centering
    \href{http://experimentationlab.berkeley.edu/sites/default/files/AFMImages/probe_unfocused1_0.png}{\includegraphics[height=230\px]{images/probe_unfocused1_0.png}}
