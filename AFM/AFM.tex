...
An atomic force microscope images objects on the scale of angstroms to microns through the use of physical scanning, rather than optics (like conventional/electron microscopes). The basic mechanism of the AFM is shown in Figure~\ref{fig:BasicMechanism}. A tip attached to a cantilever interacts with a surface. A laser is bounced off of the cantilever and into a photodetector. From this signal, one measures the deflection of the cantilever. A sample is then placed on a special stage underneath the tip. The stage contains a \href{https://en.wikipedia.org/wiki/Piezoelectricity}{\textbf{piezoelectric}} (Wikipedia link, browse at your own risk!) driver that is controlled by software. In particular, it may be made to wiggle around in a raster scan pattern, as well as engage in feedback with the cantilever (constant force mode). Variations in the height of the sample cause deflections of the cantilever, which are then picked up by the photodetector. Through this lab, you should gain a good understanding of how an AFM works, the types of data you can get from it, how you can use this data to make meaningful conclusions, and the limitations of the system.
...
\minipage{0.49\textwidth}
  \href{http://experimentationlab.berkeley.edu/sites/default/files/AFMImages/AFMprobe.JPG}{\includegraphics[width=\linewidth,keepaspectratio]{images/AFMprobe.JPG}}
  \caption{AFM probe bottom view}
  \label{fig:AFMProbe}
\endminipage\hfill
\minipage{0.49\textwidth}
  \href{http://experimentationlab.berkeley.edu/sites/default/files/AFMImages/26.png}{\includegraphics[width=\linewidth,keepaspectratio]{images/26.png}}
...
\minipage{0.4\textwidth}
  \href{http://experimentationlab.berkeley.edu/sites/default/files/AFMImages/AFMdiagram.png}{\includegraphics[width=\linewidth,keepaspectratio]{images/AFMdiagram.png}}
  \caption{Piezo integration}
  \label{fig:PiezoIntegration}
\endminipage\hfill
\minipage{0.58\textwidth}
  \href{http://experimentationlab.berkeley.edu/sites/default/files/AFMImages/AFMstage2.PNG}{\includegraphics[width=\linewidth,keepaspectratio]{images/AFMstage2.PNG}}
  \caption{Laser Setup}
...
\begin{figure}[!h]
\minipage{0.49\textwidth}
  \href{http://experimentationlab.berkeley.edu/sites/default/files/EBOX.jpg}{\includegraphics[width=\linewidth,keepaspectratio]{images/EBOX.jpg}}
  \caption{AFM EBOX}
  \label{fig:EBox}
\endminipage\hfill
\minipage{0.49\textwidth}
  \href{http://experimentationlab.berkeley.edu/sites/default/files/AFMImages/AFMconnections.PNG}{\includegraphics[width=\linewidth,keepaspectratio]{images/AFMconnections.PNG}}
...
\begin{itemize}
    ...
    \begin{figure}[h]
    \begin{center}
        \href{http://experimentationlab.berkeley.edu/sites/default/files/AFMImages/AFMwoodpecker.png}{\includegraphics[width=0.3\linewidth]{images/AFMwoodpecker.png}}
...
\begin{center}
    \href{http://experimentationlab.berkeley.edu/sites/default/files/AFMImages/toposcan.JPG}{\includegraphics[width=0.45\linewidth]{images/toposcan.JPG}}
\end{center}
...
\begin{itemize}
    ...
    \begin{center}
        \href{http://experimentationlab.berkeley.edu/sites/default/files/AFMImages/scanningmethod.jpg}{\includegraphics[width=0.6\linewidth]{images/scanningmethod.jpg}}
    \end{center}
...
\begin{itemize}
    ...
    \begin{itemize}
        \item Here are two standard \href{https://en.wikipedia.org/wiki/PID\_controller}{\textbf{GPID loops}}, (Wikipedia Link, browse at your own risk!) one for the X Piezo, and the other for the Y Piezo.  This controls the expansion characteristics of the XY piezos.
...
\begin{enumerate}
    ...
    \begin{figure}[H]
        \centering
        \href{http://experimentationlab.berkeley.edu/sites/default/files/AFMImages/AFMstagespace_0.jpg}{\includegraphics[width=0.9\linewidth]{images/AFMstagespace_0.jpg}}
    ...
    \begin{figure}[H]
        \centering
        \href{http://experimentationlab.berkeley.edu/sites/default/files/AFMImages/14.JPG}{\includegraphics[width=0.6\linewidth]{images/14.JPG}}
    ...
    \begin{figure}[H]
        \centering
        \href{http://experimentationlab.berkeley.edu/sites/default/files/AFMImages/15.JPG}{\includegraphics[width=0.6\linewidth]{images/15.JPG}}
        \caption{}
    ...
    \begin{figure}[H]
        \centering
        \href{http://experimentationlab.berkeley.edu/sites/default/files/AFMImages/17.JPG}{\includegraphics[width=0.55\linewidth]{images/17.JPG}}
        \caption{}
    \end{figure}
...
**see animation \href{http://experimentationlab.berkeley.edu/sites/default/files/AFMImages/Force-distance\_curves\_en\_video.mp4}{\textbf{Force distance curves}} (this link brings you to a new page, open link in new tab)
...
More info in\textbf{ }\href{http://experimentationlab.berkeley.edu/sites/default/files/AFMImages/Lecture\_10\_AFM.pdf}{\textbf{Lecture\_10\_AFM.pdf}} pg.17-21
