...
\begin{enumerate}
    ...
    \begin{figure}[H]
        \centering
        \href{http://experimentationlab.berkeley.edu/sites/default/files/AFMImages/14.JPG}{\includegraphics[width=0.7\linewidth]{images/14.JPG}}
    ...
    \begin{figure}[H]
        \centering
        \href{http://experimentationlab.berkeley.edu/sites/default/files/AFMImages/15.JPG}{\includegraphics[width=0.7\linewidth]{images/15.JPG}}
        \caption{Probe clip on exchange tool}
