...
\href{http://experimentationlab.berkeley.edu/sites/default/files/AFMImages/bothfocused.JPG}{\includegraphics[width=0.33\linewidth,keepaspectratio]{images/bothfocused.JPG}}
...
\begin{figure}[h]
    \centering
    \href{http://dev-physicsadv.pantheon.berkeley.edu/sites/default/files/AFMImages/12.JPG}{\includegraphics[width=0.5\linewidth]{images/12.JPG}}
    \caption{}
    \label{fig:12}
\end{figure}
