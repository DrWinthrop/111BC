...
\textbf{Checkpoint: Describe the various components of the LabView program to a GSI and explain what and ho
...
\begin{enumerate}
    ...
    You will need to use the ``Signal Point Scan'' for this part before seeing any signals from the appartatus. Refer to section setup of the \hyperref[subsec:IntegrateSinglePointProgram]{Signal Point Scan}
    ...
    \begin{figure}[h]
        \centering
        \href{http://experimentationlab.berkeley.edu/sites/default/files/images/BRAimage015.jpg}{\includegraphics[width=0.45\linewidth]{images/BRAimage015.jpg}}
        \caption{}
        \label{fig:Signal1}
    \end{figure}
    ...
    \begin{figure}[h]
        \centering
        \href{http://experimentationlab.berkeley.edu/sites/default/files/images/320px-BRAimage016.jpg}{\includegraphics[width=0.45\linewidth]{images/320px-BRAimage016.jpg}}
        \caption{}
        \label{fig:Signal2}
    \end{figure}
...
\label{sec:References}
    ...
    \bibitem{Feister} I. Feister, ``\href{http://prola.aps.org/abstract/PR/v78/i4/p375\_1}{\textbf{Numerical Evaluation of the Fermi Beta-Distribution Function}}'', Physical Review 78, 4 (1950) *\*.
