...
\noindent
\href{http://experimentationlab.berkeley.edu/sites/default/files/images/Bra_1.jpg}{\includegraphics[width=0.33\linewidth,keepaspectratio]{images/Bra_1.jpg}}
\href{http://experimentationlab.berkeley.edu/sites/default/files/images/RCA6655A_PMT_3.jpg}{\includegraphics[width=0.33\linewidth,keepaspectratio]{images/RCA6655A_PMT_3.jpg}}
\href{http://experimentationlab.berkeley.edu/sites/default/files/images/BRA_Rack_1.jpg}{\includegraphics[width=0.33\linewidth,keepaspectratio]{images/BRA_Rack_1.jpg}}
...
\begin{enumerate}
    ...
    \item \textbf{Radiation Safety SOP} View the \href{http://youtu.be/KHxtzF5pZZM}{\textbf{'\textbf{Radiation Safety Video'}}}. After watching the video in the 111-Lab, get a pink Radiation Safety form from a 111-Lab staff person. Fill it out \& sign the form for getting a \textbf{Radiation Ring}.
...
Additionally, the excited state of Barium ${}^{137}Ba^{*} $ (daughter product in (1)), can subsequently decay as follows:

In (3), the ${}^{137}Ba^{*}$ decays by emitting a 0.662 MeV $\gamma$-ray, In (4), the excited barium nucleus decays by interacting with a nearby bound electron in a process called \emph{internal conversion}.

The two beta-decays give a continuous energy spectrum of the emitted electrons, while the internal conversion reaction gives sharp k-, l- and m-peaks in energy (page 125 in the reprints). Fig. 2a is a representative spectrum. It is a plot of the number of electrons N vs. momentum p. The curve is the sum of the three decays described above that emit electrons. The peak on the low energy side of the k-peak is an artifact of the apparatus.

\noindent
\href{http://experimentationlab.berkeley.edu/sites/default/files/images/BRAimage008.gif}{\includegraphics[width=0.33\linewidth,keepaspectratio]{images/BRAimage008.png}}
\href{http://experimentationlab.berkeley.edu/sites/default/files/images/BRAimage009.gif}{\includegraphics[width=0.33\linewidth,keepaspectratio]{images/BRAimage009.png}}
...
\textbf{Figure 5a}\section{Apparatus}
...
\begin{figure}[h]
    ...
    \caption{}
    \label{fig:600px-BRAimage010}
\end{figure}

The spectrometer is a 'C'-shaped vacuum chamber with conducting coils on top and bottom to produce a uniform magnetic field perpendicular to the horizontal plane of the chamber. The size of the chamber is 0.4375`` x 3.375'' (transverse dimensions). A source of $^{137}$Cs is permanently mounted inside the chamber at one end of a rod (see Figure 3a in the 'C' diagram). As shown in Figure 3b, the detector is mounted at the other end, behind a slit (0.375`` high x 0.125'' wide). The detector is a piece of 1-inch in diameter plastic scintillator, wrapped with a 2-mil aluminized mylar foil, attached to a 1-1/2 inch diameter light pipe connected to a 6655A photomultiplier tube (PMT).
...
\section{Diagram of Photomultiplier Tube}
...
Diagram of inside of Photomuliplier Tube and shows how it works.\begin{figure}[h]
    \centering
...
Circuit diagram of the PMT Base\section{Procedure}

First read and get familiar with the LabView Beta Ray Computer Program  [\href{http://physics111.lib.berkeley.edu/Physics111/Reprints/BRA/02-Beta\_Ray\_Spectrometer.pdf}{\textbf{[1]}}] which describe the operation of the computerized data-acquisition program that communicates with the DAQ card and controls data taking. The current is supplied to the magnet by a DC power supply in series with a current DVM meter through the relay circuits which can only be set to a particular value with this computer program.

\section{Set the signal and discriminator levels}
...
\begin{figure}[h]
    \centering
    \href{http://experimentationlab.berkeley.edu/sites/default/files/images/BRAimage017.jpg}{\includegraphics[width=0.5\linewidth]{images/BRAimage017.jpg}}
    \caption{}
    \label{fig:BRAimage017}
\end{figure}
...
\section{Observe the effects of statistical fluctuations.}
...
\section{Observe the effect of hysteresis}
...
\section{Take data using the Beta Ray Scan Program to scan the entire beta ray spectrum}
...
\noindent
\href{http://experimentationlab.berkeley.edu/sites/default/files/images/280px-BRAimage028.gif}{\includegraphics[width=0.33\linewidth,keepaspectratio]{images/280px-BRAimage028.png}}
\href{http://experimentationlab.berkeley.edu/sites/default/files/images/BRAimage029.gif}{\includegraphics[width=0.33\linewidth,keepaspectratio]{images/BRAimage029.png}}

The K-peak of the beta spectrum occurs at a specific field strength, marked $B_k$. If B were directly proportional to the coil-current, the K-peak would always be detected at current $i_k$. Instead, as you take data with the current increasing, the peak occurs at $i_{ku}$, and as the current decreases the peak occurs at $i_{kd}$. This is true for every point of the spectrum, which means that both spectra you take will be shifted away (in opposite directions of I) from the spectrum you would get if there were no hysteresis. Figure 5C is closer to the real hysteresis curve for the beta spectrometer magnet.

Headline text\section{The Beta Ray Scan Program:}
...
Your data will be saved on the 111-Lab server backed up every night by the campus. Data is saved in your own home directory in \\\\Atlas2\\redirect\$\\your\_Directory\_name\\My Documents\\LabVIEW Data\\then either ``BRA DataXX'' or Single PointXX" .
...
\begin{figure}[h]
    \centering
    \href{http://experimentationlab.berkeley.edu/sites/default/files/images/BRAimage035.gif}{\includegraphics[width=0.5\linewidth]{images/BRAimage035.png}}
    \caption{}
    \label{fig:BRAimage035}
\end{figure}


\begin{figure}[h]
    \centering
    \href{http://experimentationlab.berkeley.edu/sites/default/files/images/BRAimage036.gif}{\includegraphics[width=0.5\linewidth]{images/BRAimage036.png}}
    \caption{}
    \label{fig:BRAimage036}
\end{figure}
...
\section{The integrate single point program:}


\begin{figure}[h]
    \centering
    \href{http://experimentationlab.berkeley.edu/sites/default/files/images/BRAimage037.gif}{\includegraphics[width=0.5\linewidth]{images/BRAimage037.png}}
    \caption{}
    \label{fig:BRAimage037}
\end{figure}
...
\textbf{Fermi-Kurie Transform}Fermi-Kurie Transform creates a new DataSet that is the Fermi-Kurie plot of the current one [see NBS for complete treatment]. The transform is a theoretical one that changes the DataSet into a straight line. The transformation is: $ \left(x_{i},y_{i}\right)\rightarrow\left(\sqrt{x_{i}^{2}+1}-1,\sqrt{\frac{y_{i}}{x_{i}^{2}\cdot F\left(Z,x_{i}\right)}}\right)$

where $F \left ( Z, x_{i} \right )$ is the Quantum-mechanical correction for coulomb effects on the beta-particle as it leaves the parent atom. $F \left ( Z, x_{i} \right )$ is calculated using the Bethe-Bacher approximation but the screening effect [ref 3 §12] is neglected (to see why, you should calculate the size of this effect for $^{137}$Cs). This transformation assumes that the x-axis is momentum and has been calibrated in units of $m_{e} c$. The resulting x-axis is then kinetic energy in units of $m_{e}c^{2}$. If the input DataSet begins with negative momenta, \emph{Matlab} will handle this information and begin processing data.

\textbf{Inverse Fermi-Kurie Transform}The inverse Fermi-Kurie feature inverts the previous algorithm producing:
...
\section{What does artifact mean?}
...
\begin{figure}[h]
    ...
    \caption{}
    \label{fig:BRAimage041}
\end{figure}




\textbf{Figure 2c} Note the ``artifact'' peak to the left of the k-peak at Bin \# 2200; see \textbf{Figure 2a}So now we can deconvolute our data and find our true Beta spectrum Figure 6D. Resultant Beta spectrum, see the K-peak at Bin \# 2200 and L-peak to the right of it.
...
\begin{figure}[h]
    ...
    \caption{}
    \label{fig:BRAimage019}
\end{figure}

Fit a line to this curve and get the end-point on the X-axis, Q1. Pick a region above the noise and above the K-peak where it is linear. Now do a inverse Fermi-Kurie plot. You will get something like the following graph.
...
\begin{figure}[h]
    ...
    \caption{}
    \label{fig:BRAimage021}
\end{figure}

You should repeat the steps above to get the low-energy component and the low-energy end-point Q2.
...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item Check out \href{http://experimentationlab.berkeley.edu/EAX}{\textbf{\textbf{Error Analysis Notes}}} and the video on Error Analysis.
...
\begin{enumerate}
    \item M. Siegbahn, \href{http://physics111.lib.berkeley.edu/Physics111/Reprints/BRA/02-Beta\_Ray\_Spectrometer.pdf}{\textbf{Beta and Gamma Spectroscopy}}, Ch. 3.‡

    \item K. S. Krane,``\href{http://physics111.lib.berkeley.edu/Physics111/Reprints/BRA/03-Beta\_Decay.pdf}{\textbf{Beta Decay}}.'' Introductory Nuclear Physics, Chapter 9, pp.272-288. John Wiles and Sons., 1987.

    \item \href{http://physics111.lib.berkeley.edu/Physics111/Equipment\_Manuals/RCA\_PMT.pdf}{\textbf{Photo-multiplier tube Handbook}}‡ (Note this is a separate reprint booklet)

    \item I. Feister, ``\href{http://prola.aps.org/abstract/PR/v78/i4/p375\_1}{\textbf{Numerical Evaluation of the Fermi Beta-Distribution Function}}'', Physical Review 78, 4 (1950) ‡\*.

    \item L.R.B. Elton, ``\href{http://physics111.lib.berkeley.edu/Physics111/Reprints/BRA/Elton\_Nuclear\%20Theory\%20Ch.\%209\%20Beta\%20Decay.pdf}{\textbf{Chapter 9: Beta Ray Theory}}'', Introductory Nuclear Theory, 2nd ed.; 1966, W.B. Saunders Company,PA
