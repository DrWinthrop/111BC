...
\begin{enumerate}
    ...
    \item J.J. DiStefano, A.R. Stubberud, and I.J. Williams. \href{http://books.google.com/books?hl=en&lr=&id=ixnpRIr\_CHUC&oi=fnd&pg=PA39&dq=book+by++DiStefano,+Stubberud,+and++Williams+Schaum\%E2\%80\%99s+outline+of+theory+and+problems+of+feedback+and+control+systems+&ots=F6GBDMlFZW&sig=L7DJfMx8uqkgt8itFFwlQCB5\_Bs#v=onepage&q=&f=false}{\textbf{Schaum’s outline of theory and problems of feedback and control systems online book}}
...
\begin{equation}
    P(\vec{v}) \propto e^{-mv^2/k_BT} \quad \text{or} \quad P(v) \propto v^2e^{-mv^2/k_BT}
\end{equation}
...
\begin{equation}
    v_c \simeq \sqrt{\frac{2F_{max}D}{m}}
\end{equation}
...
\begin{figure}[h]
    ...
    \caption{The energy levels for $^{85}$Rb are shown above with the relative frequency differences between levels. The unidirectional arrows indicate the $D_2$ transition from the 5S$_{1/2}$ ground state to the 5P$_{3/2}$ excited state.}
...
Figure 4: Optical Setup for the MOT experiment
...
\textbf{An interface to the triggered CCD camera}
...
\textbf{Using the MOT VI as a digital storage scope}
...
The viscous nature of radiation pressure forces is most evident in optical molasses. Without the confining effects of inhomogeneous Zeeman shifts, the propagation of atoms exposed to counter-propagating red-detuned light is diffusive, rather than ballistic, as described .
...
\label{sec:References}
    ...
    \bibitem{Phillips} W.D. Phillips. \href{http://journals.aps.org/rmp/pdf/10.1103/RevModPhys.70.721}{\textbf{``Nobel Lecture: Laser cooling and trapping of neutral atoms,''}} Reviews of Modern Physics 70, 721 (1998).

    \bibitem{Raab} E. Raab, M. Prentiss, A. Cable, S. Chu, and D. Pritchard. \href{http://journals.aps.org/prl/pdf/10.1103/PhysRevLett.59.2631}{\textbf{``Trapping of neutral sodium atoms with radiation pressure,''}} Physical Review Letters 59, 2631 (1987).
    ...
    \bibitem{Steck} ``\href{http://steck.us/alkalidata/rubidium85numbers.pdf}{\textbf{Rubidium 85 D line data}}'' and ``\href{http://steck.us/alkalidata/rubidium87numbers.pdf}{\textbf{Rubidium 87 D line data}}'' Dan Steck, University of Oregon. \href{http://steck.us/alkalidata/}{\textbf{Documents available}}

    \bibitem{Siddons} P. Siddons, C.S. Adams, C. Ge and I.G. Hughes, ``Absolute absorption on rubidium D lines: comparison between theory and experiment,'' Journal of Physics B: Atomic, Molecular and Optical Physics 41, 155004 (2008).

    \bibitem{Monroe} C. Monroe, W. Swann, H. Robinson, and C. Wieman. \href{http://dev-physicsadv.pantheon.berkeley.edu/sites/default/files/images/Monroe\_etal.pdf}{\textbf{``Very Cold Trapped Atoms in a Vapor Cell.''}} Physical Review Letters 65, 1571 (1990).
    ...
    \bibitem{Bechhoefer} J. Bechhoefer. \href{http://journals.aps.org/rmp/pdf/10.1103/RevModPhys.77.783}{\textbf{``Feedback for physicists: A tutorial essay on control''}} Reviews of Modern Physics 77, 783 (2005)

    \bibitem{Wieman} C.E. Wieman and L. Hollberg. ``\href{http://physics111.lib.berkeley.edu/Physics111/Reprints/MOT/Weiman\_in\_Denver\_MOT.pdf}{\textbf{Using diode lasers for atomic physics}},'' Review of Scientific Instruments 62, 1 (1991). A comprehensive guide to diode lasers
    ...
    \bibitem{Corwin} Corwin et al., ``\href{http://dev-physicsadv.pantheon.berkeley.edu/sites/default/files/images/Corwin\_DAVLL.pdf}{\textbf{Frequency-stabilized diode laser with the Zeeman shift in an atomic vapor}}'' Applied Optics 37, 3295 (1998).

    \bibitem{Moore} John H. Moore, Christopher C. Davis, Michael A. Coplan, ``Building Scientific Apparatus, 4th ed.'', Cambridge University Press (2009).
\end{thebibliography}
