...
\begin{enumerate}
    ...
    \item \signatures \hyperlink{Variable High Voltage Supply}{ 1}  \hyperlink{Change of Pulses}{ 2} \hyperlink{Parameters}{ 3} \hyperlink{Attenuation and Recognition of the Back-Scatter and Compton Edge Signals}{ 4} \hyperlink{Intensity Formula}{ 5}
