...
\begin{enumerate}
    ...
    \checkpoint{Change of Pulses}{For a given radioactive sample (in a bottle) what are  some things that can produce a change in coherent time producing a spread of the peak with a finite width in the Pulse Height analyzer? (You should be thinking about what's going on in the bottle)}
