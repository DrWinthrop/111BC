...
%\newcommand{\K.C.NeumanandS.M.Block,"OpticalTrapping,"Rev.Sci.Instrum.75,2787(2004)}{http://rsi.aip.org/resource/1/rsinak/v75/i9/p2787_s1}
...
%\newcommand{\ArthurAshkin,"Accelerationandtrappingofparticlesbyradiationpressure",Phys.Rev.Let.24(4),156(1970)}{http://prl.aps.org/abstract/PRL/v24/i4/p156_1}
%\newcommand{\ArthurAshkin,Opticaltrappingandmanipulationofneutralparticlesusinglasers,Proc.Natl.Acad.Sci.94,4853(1997).}{http://www.pnas.org/content/94/10/4853.full}
%\newcommand{\[3]}{http://glass.phys.uniroma1.it/dileonardo/Applet.php?applet=TrapForcesApplet}
%\newcommand{\J.Bechhoefer,S.Wilson,"Faster,cheaper,saferopticaltweezersfortheundergraduatelaboratory",Am.J.Phys.,70,393(2002)}{http://ajp.aapt.org/resource/1/ajpias/v70/i4/p393_s1}
%\newcommand{\J.W.Shaevitz,Apracticalguidetoopticaltrapping}{http://sites.google.com/site/shaevitzlab/links}
...
%\newcommand{\here.}{http://dev-physicsadv.pantheon.berkeley.edu/sites/default/files/ZIP_files/OTZ_Matlab_files.zip}
...
\noindent
\href{http://experimentationlab.berkeley.edu/sites/default/files/images/OTZ_0141B.jpg}{\includegraphics[width=0.33\linewidth,keepaspectratio]{images/OTZ_0141B.jpg}}
\href{http://experimentationlab.berkeley.edu/sites/default/files/images/OTZ_3551_Crop.jpg}{\includegraphics[width=0.33\linewidth,keepaspectratio]{images/OTZ_3551_Crop.jpg}}
\href{http://experimentationlab.berkeley.edu/sites/default/files/images/OTZ_Controls_0142B.jpg}{\includegraphics[width=0.33\linewidth,keepaspectratio]{images/OTZ_Controls_0142B.jpg}}
\href{http://experimentationlab.berkeley.edu/sites/default/files/images/OTZ_Table_3555.jpg}{\includegraphics[width=0.33\linewidth,keepaspectratio]{images/OTZ_Table_3555.jpg}}
\href{http://experimentationlab.berkeley.edu/sites/default/files/images/OTZ_Laser_Controller_3553.jpg}{\includegraphics[width=0.33\linewidth,keepaspectratio]{images/OTZ_Laser_Controller_3553.jpg}}
...
From the 975 nm laser it goes through two steering mirrors, then 1/2 waveplate at 980nm bandpass,, ( DO NOT ADJUST or TURN IT) then goes through lens, then to the 95 0nm Shortpass Dichoric mirror. With the addition of the point Grey camera, we needed to remove the Shott filter KG-5, but the FG900 filter is still installed.
...
\begin{enumerate}
    ...
    \item Press the down arrow key to move to the ``TE Cfg: Model'' page. Scroll to ``*0) NTC Β,R(t),t'' (if it is not already on it). Arrow down to set the values of Β, R(\emph{t}0), and \emph{t}0, which should be 3800C, 10k$\Omega$, and 25C, respectively.
...
Settings = fscanf(fid,`Sample Rate: \%f\textbackslash nNumberOfSeconds: \%f\textbackslash nParticleDiameter: \%f\textbackslash nViscosity: \%f\textbackslash nxStiffness: \%f\textbackslash nyStiffness: \%f\textbackslash nxSensitivity: \%f\textbackslash nySensitivity: \%f\textbackslash n');
...
\begin{figure}[h]
    ...
    \caption{A plot of Vx vs time for a stuck bead moved from left to right. The red line is fitted to the data from the linear region.}
...
[Kx,Ky] = equipartition(x\_sensvspwr, y\_sensvspwr, data1, pwr1, data2, pwr2, ...)
...
\label{sec:References}
    \bibitem{Ashkin1970} \href{http://prl.aps.org/abstract/PRL/v24/i4/p156\_1}{\textbf{Arthur Ashkin, ``Acceleration and trapping of particles by radiation pressure'', Phys. Rev. Let. \textbf{24}(4), 156 (1970)}}. This is the original paper debuting the practice of optical trapping using two opposing lasers.
    ...
    \bibitem{Neuman} \href{http://rsi.aip.org/resource/1/rsinak/v75/i9/p2787\_s1}{\textbf{K. C. Neuman and S. M. Block, ``Optical Trapping,'' Rev. Sci. Instrum. \textbf{75}, 2787 (2004)}}
