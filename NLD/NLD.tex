...
LabView is a graphical programming environment designed to facilitate lab-instrument control, \\ data-acquisition, and rudimentary numerical analysis. There is a suite of LabView programs (called VI's; for Virtual Instruments) specifically written for this lab that constitutes the bulk of this experiment. \textbf{Use \emph{LabVIEW 2015} for this part.} You'll also be writing a few of your own to get a better feel for LabView. \textbf{Use \emph{LabVIEW 2016} for this part.} The distinction between versions is made here, because the custom built VI's call on the CALLCORR.VI sub-vi, which uses a 32 bit file that requires a 32 bit version of LabVIEW to run.
...
\begin{figure}[H]
    \centering
    \href{http://experimentationlab.berkeley.edu/sites/default/files/images/Nldimage107.gif}{\includegraphics[width=0.6\linewidth]{images/Nldimage107.png}}
...
\textbf{NOTE: Up to this point, you have been using \emph{LabVIEW 2016}. It is absolutely imperative that you switch over to \emph{LabVIEW 2015}, because this version is 32 bit and can run the necessary sub VI's.}

\subsection{NLSIM.VI: the simulation VI (LabVIEW 2015)}
...
\begin{figure}[H]
    \centering
    \href{http://experimentationlab.berkeley.edu/sites/default/files/images/NLD_DAQBOX.png}{\includegraphics[width=0.7\linewidth]{images/NLD_DAQBOX.png}}
...
\begin{figure}[H]
    \centering
    \href{http://experimentationlab.berkeley.edu/sites/default/files/images/NLD_PN_DIAGRAM.png}{\includegraphics[width=0.8\linewidth]{images/NLD_PN_DIAGRAM.png}}
