...
\begin{enumerate}
    ...
    \item \href{http://dev-physicsadv.pantheon.berkeley.edu/node/86}{\textbf{Exponential Probability Distributions}}
    
    \item \href{http://dev-physicsadv.pantheon.berkeley.edu/EAX}{\textbf{Error Analysis Notes}}
    
    \item \href{http://dev-physicsadv.pantheon.berkeley.edu/node/88}{\textbf{National Instruments Digitizer VI}}
